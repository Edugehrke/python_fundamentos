...
class Alimento(ABC):
    def __init__(self,calorias,nome) -> None:
...
def calcula_calorias(lista_caloria):
    soma_calorias = 0 
...
print(f'{calorias_total_legumes}kcal')


frango = Carne(100, 'File de peito')
...
print(f'{calorias_total_carnes}kcal')
...
print(f'{calorias_total_frutas}kcal')
